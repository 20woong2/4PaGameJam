...
public class InputResult : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 결과 표시
        displayTextA.text = "입력된 숫자: " + AirSetting.AirResult[0];
        displayTextB.text = "입력된 숫자: " + AirSetting.AirResult[1];
        displayTextC.text = "입력된 숫자: " + AirSetting.AirResult[2];
        displayTextD.text = "입력된 숫자: " + AirSetting.AirResult[3];
    }
